...
export class Machine_DriverController {
  ...
  async createMachine_Driver(
    ...
    return await this.machineService.createMachine_Driver(createMachine_DriverDto);
  }
  @Get()
  ...
  async updateMachine_Driver(
    ...
    return await this.machineService.updateMachine_Driver(+id, updateMachine_DriverDto);
  }
}
